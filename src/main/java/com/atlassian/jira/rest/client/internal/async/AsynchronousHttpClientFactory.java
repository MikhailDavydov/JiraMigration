 ...
 * 
 * 
 * Modified based on the following post:
 * https://answers.atlassian.com/questions/156425/java-jira-rest-api-connect-problem
 * 
 */
...
public class AsynchronousHttpClientFactory {
	...
	public DisposableHttpClient createClient(final URI serverUri, final AuthenticationHandler authenticationHandler) {
		...
		options.setSocketTimeout(3, TimeUnit.MINUTES); // 3 mins timeout for slow jira queries
